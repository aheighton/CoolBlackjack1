...
public class GameTest
{
	...
	public void testGameStart(){
		...
		assertEquals(player1.getAbility(),"","Players are given cheats before deal.");
		assertEquals(player2.getAbility(),"","Players are given cheats before deal.");

		game.setDeck(new Deck());
		game.deal();

		assertNotEquals(player1.getAbility(),"","Players are not given cheats after deal.");
		assertNotEquals(player2.getAbility(),"","Players are not given cheats after deal.");
